...
const ArrangmentBox = styled(Box)(
  sx({
    display: 'flex',justifyContent: 'space-between',paddingTop: 6,paddingBottom: 6,paddingLeft:7,paddingRight:7,marginLeft:3,marginRight:3,
  }),);
...
const menuItems = ['No Filter','Africa', 'America', 'Asia', 'Europe','Oceania','Favorites'];
const cardElement1 = [
...
<TopBar text="Where in the world?" button="Dark Mode"/>
       ...
       <ArrangmentBox sx={responsiveDiv}>
        <div ><SearchFeild placehoderValue="Search for a country..."/></div>
       <div ><MenuPopupState items={menuItems} menuTopic="Filter by"/></div>
      </ArrangmentBox>



      <Box sx={{display: 'flex',justifyContent: {xs:'center',md:'row',lg:'row',},marginLeft:{xs: 7, md:3,lg:3,},paddingLeft:{sm: 0, md: 7,lg:7,}}}>
      ...
      <Grid container rowSpacing={9} columnSpacing={1}>
        <Grid item xs={12} md={6} lg={4}>
          <Link style={linkStyle} to="/DetailsPage"><ActionAreaCard style={cards} countryName="Belgium" cardElements={cardElement1} flag={mainFlag}/>  </Link>
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
         <ActionAreaCard countryName="United States of America" cardElements={cardElement2} flag={us}/>
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
          <ActionAreaCard countryName="Brazil" cardElements={cardElement3} flag={br}/>
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
          <ActionAreaCard countryName="Iceland" cardElements={cardElement4} flag={is}/>
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
          <ActionAreaCard countryName="Afghanistan" cardElements={cardElement5} flag={af}/>
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
          <ActionAreaCard countryName="Aland Islands" cardElements={cardElement6} flag={ax}/>
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
        <ActionAreaCard countryName="Albania" cardElements={cardElement7} flag={al}/>
        </Grid>
        <Grid item xs={12} md={6} lg={4}>
          <ActionAreaCard countryName="Algeria" cardElements={cardElement8} flag={dz}/>
        </Grid>
          <Grid item xs={12} md={6} lg={4}>
          <ActionAreaCard countryName="Germany" cardElements={cardElement9} flag={de}/>
        </Grid>
      </Grid>
    </Box>
        </Grid>
